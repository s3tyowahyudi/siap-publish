...
<script src="assets/ace/assets/js/jquery-ui.custom.js"></script>
<script src="assets/ace/assets/js/jquery.ui.touch-punch.js"></script>
<script src="assets/ace/assets/js/ace/elements.fileinput.js"></script>
...
@include('includes.dokumen.index')
@include('includes.dokumen.dokumenVue')